        ...
        while (infiniteLoop) {
			...
			System.out.println("=================================");
                ...
                if (accountIndex > size) {
                    ...
                    System.out.println(
                            accountName[accountIndex] + " your balance is " + accountBalance[accountIndex] + "Tk.");
                }
			System.out.println("=================================");
            } else if (option == 4) {
                ...
                if (accountIndex > size) {
                    ...
                    System.out.println(accountName[accountIndex] + " your updated balance is : "
                            + accountBalance[accountIndex] + " Tk. \n ");
                }
			System.out.println("=================================");
            } else if (option == 5) {
			...
			System.out.println("=================================");
                ...
                System.out.println("Terminating...");
				System.out.println("Developed & Managed by me@Codingal");
				System.out.println("Built with ❤ in Bd");
